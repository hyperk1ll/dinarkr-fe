                    ...
                    <ul className="space-y-2">
                        ...
                        <li>
                            <a href="/produk"
                                ...
                                <span className="flex-1 ml-3 whitespace-nowrap">Lihat Produk</span>
                            </a>
                        </li>
                        <li>
                            <a href="/transaksi"
                                ...
                                <span className="flex-1 ml-3 whitespace-nowrap">Tambah Transaksi</span>
                            </a>
                        </li>
                        <li>
                            <a href="/riwayat"
                                ...
                                <svg className='flex-shrink-0 w-6 h-5 text-gray-500 transition duration-75  group-hover:text-gray-900 ' fill='currentColor' viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                                    <g  fill="currentColor">
                                ...
                                <span className="flex-1 ml-3 whitespace-nowrap">Riwayat Transaksi</span>
                            </a>
                        </li>
                        <li>
                            <a href="#"
                                className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg  hover:bg-gray-100 ">
                                <svg className='flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75  group-hover:text-gray-900 ' xmlns="http://www.w3.org/2000/svg" 
                                ...
                                <span className="flex-1 ml-3 whitespace-nowrap">Pembelian</span>
                            </a>
                        </li>
                        <li>
                            <a href="#"
                                ...
                                <span className="flex-1 ml-3 whitespace-nowrap">Penjualan</span>
                            </a>
                        </li>
                    </ul>
                </div>
